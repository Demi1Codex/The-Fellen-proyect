...
class CreditsCFellen extends funkin.options.OptionsScreen {
	public var error:Bool = false;
	public var author:String = "Demi1Codex";
	public var totalContributions:Int = 0;

	public var mainDevCol:FlxColor = 0xFF120AFE;
	public var minContrCol:FlxColor = 0xFF6191E4;
	public var contribFormats:Array<FlxTextFormatMarkerPair> = [];

	public override function new()
	{
		super("Proyect Fellen", "Todos en la creacion del mod! - Press RESET to update the list (One reset per 2 minutes).");
		tryUpdating(true);
	}
	...
	public function checkUpdate():Bool {
		...
		error = false;
		var idk = GitHub.getContributors(author, "Demi1Codex", function(e) {
			error = true;
